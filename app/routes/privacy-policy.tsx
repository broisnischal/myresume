...
export default function Page() {
  return (
    <div className="py-32">
      <div className="flex flex-col gap-6 container max-w-[95%] lg:max-w-[50vw]">
        ...
        <ul>
          ...
          <li>
            <p>
              ...
              "We", "Us" or "Our" in this Agreement) refers to broisnischal,
              Kathmandu.
            </p>
          </li>
          <li>
          ...
          <li>
            <p>
              <strong>Website</strong> refers to My Resume, accessible from{" "}
              <a
                href="https://myresume.fly.ap"
                rel="external nofollow noopener"
                target="_blank"
              >
                https://myresume.fly.ap
              </a>
            </p>
          </li>
          <li>
        ...
        <ul>
          <li>
            ...
            <a
              href="https://myresume.fly.dev/contact"
              rel="external nofollow noopener"
              target="_blank"
            >
              https://myresume.fly.dev/contact
            </a>
          </li>
        </ul>
      </div>
