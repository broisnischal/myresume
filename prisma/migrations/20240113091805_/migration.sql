...
-- CreateEnum
CREATE TYPE "EventAnalytics" AS ENUM ('RESUME_CLICK', 'LINK_CLICK', 'SOCIAL_CLICK', 'PROFILE_VIEW');
...
-- AddForeignKey
ALTER TABLE "Analytics" ADD CONSTRAINT "Analytics_resumeId_fkey" FOREIGN KEY ("resumeId") REFERENCES "Resume"("id") ON DELETE SET NULL ON UPDATE CASCADE;
